  ...
  return (
    <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
       ...
       <div className='text-center mt-20 mb-8'>
         ...
         <img src={assets.star_icon} alt="star" width='12.81' />
      ...
      <form  className='flex justify-between max-w-lg max-sm:scale-75 mx-auto border border-gray-300 bg-white rounded overflow-hidden'>
        <input type="text" placeholder='Search blogs' className='w-fit pl-4 outline-none' required />
        <button type='submit' className='bg-primary text-white md:py-1 px-8 py-2 m-1.5 rounded hover:scale-105 transition-all cursor-pointer'>Search</button>
      </form>

       </div>

        <img src={assets.gradientBackground} alt="gbg"  className='absolute -top-50 -z-1 opacity-50'/>
