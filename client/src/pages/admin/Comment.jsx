...
import CommentTableItelm from '../../components/admin/CommentTableItelm'
  ...
  return (
    <div className='flex-1 pt-5 px-5 sm:pt-12 sm:pl-16 bg-blue-50/50'>
      <div className="flex justify-between items-center max-w-3xl">
        <h1 className='pr-[10px]'>Comments</h1>
        ...
        <table className='w-full text-sm text-gray-500'>
          <thead className='text-xs text-gray-700 text-left uppercase'>
            <tr>
              ...
              <th scope='col' className='px-6 max-sm:hidden py-3'>Date</th>
          ...
          <tbody>
            {comments.filter((comment) => {
              ...
              <CommentTableItelm key={comment._id} comment={comment} index={index + 1} fetchComments={fetchComments}  />
            )}
          </tbody>
        </table>
      </div>
